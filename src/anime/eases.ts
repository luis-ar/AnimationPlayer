import { minValue, emptyString } from "./consts";
 ...
 */
export const cubicBezier = (mX1, mY1, mX2, mY2) =>
  mX1 === mY1 && mX2 === mY2
    ? none
    : (t) =>
        t === 0 || t === 1
...
for (let type in easeTypes) {
  for (let name in easeInFunctions) {
    ...
    /** @type {EaseFactory} */
    easesLookups[easeName] = hasParams
      ? /** @type {EasesFactory} */ easeFactory()
      : easeFactory;
  }
}
 ...
 * @return {EasingFunction}
 */
export const parseEasings = (ease) =>
  isFnc(ease)
    ? ease
    : isStr(ease)
    ? easesLookups[ease]
